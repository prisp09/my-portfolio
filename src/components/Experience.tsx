...
export default function Experience() {
  return (
    <Section id="experience">
      ...
      <Reveal>
        <div className="grid gap-8 lg:grid-cols-[1fr_1fr_1.2fr] lg:items-start lg:gap-12">
          ...
          <dl className="space-y-3 border-t border-white/[0.06] pt-6 font-mono text-xs lg:border-l lg:border-t-0 lg:pl-8 lg:pt-1">
